...
PACKAGE ?= helm-jaeger
XRD_DIR := apis/jaegers
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/jaegers/standard.yaml
...
EXAMPLES := \
    examples/jaegers/minimal.yaml:: \
    examples/jaegers/standard.yaml::
